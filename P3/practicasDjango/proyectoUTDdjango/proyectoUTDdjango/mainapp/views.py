...
@login_required(login_url='index')
def mision(request):
    return render(request, 'mainapp/mision.html', { 'title': 'Misión',
    'content': 'Esta es la misión de la empresa.' })

@login_required(login_url='index')
def vision(request):
    return render(request, 'mainapp/vision.html', { 'title': 'Visión',
    'content': 'Esta es la visión de la empresa.' })
