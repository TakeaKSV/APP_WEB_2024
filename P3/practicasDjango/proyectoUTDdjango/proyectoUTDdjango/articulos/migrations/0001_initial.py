# Generated by Django 5.1.1 on 2024-11-26 15:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(max_length=255, verbose_name='Contenido')),
                ...
                ('categories', models.ManyToManyField(blank=True, max_length=255, to='articulos.category', verbose_name='Categorias')),
            ],
            options={
